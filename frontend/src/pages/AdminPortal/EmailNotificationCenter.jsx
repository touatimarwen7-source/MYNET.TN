...
export default function EmailNotificationCenter() {
  const [notifications] = useState([
    { id: 1, recipient: 'buyers@example.com', subject: 'أجل جديد متاح', status: 'نجح', date: '2025-01-26 10:00' },
    { id: 2, recipient: 'suppliers@test.com', subject: 'طلب عرض جديد', status: 'نجح', date: '2025-01-26 09:30' },
    { id: 3, recipient: 'admin@mynet.tn', subject: 'تقرير يومي', status: 'قيد الانتظار', date: '2025-01-26 08:00' },
  ]);
            ...
            <Grid xs={12} lg={6} lg={3}>
              <Card sx={{ backgroundColor: '#FFFFFF', border: '1px solid #e0e0e0', borderRadius: '8px' }}>
                <CardContent>
                  ...
                  <Typography variant="h4" sx={{ fontWeight: 700, color: '#2e7d32', mt: 1 }}>68%</Typography>
                </CardContent>
              </Card>
            </Grid>
            <Grid xs={12} lg={6} lg={3}>
              <Card sx={{ backgroundColor: '#FFFFFF', border: '1px solid #e0e0e0', borderRadius: '8px' }}>
                <CardContent>
                  ...
                  <Typography variant="h4" sx={{ fontWeight: 700, color: '#f57c00', mt: 1 }}>24%</Typography>
                </CardContent>
              </Card>
            </Grid>
            <Grid xs={12} lg={6} lg={3}>
              <Card sx={{ backgroundColor: '#FFFFFF', border: '1px solid #e0e0e0', borderRadius: '8px' }}>
                <CardContent>
                  ...
                  <Typography variant="h4" sx={{ fontWeight: 700, color: '#d32f2f', mt: 1 }}>125</Typography>
                </CardContent>
              </Card>
            </Grid>
          </Grid>
            ...
            <CardContent>
              <Stack spacing={2}>
                {templates.map((template) => (
                  <Stack key={template.id} direction="row" justifyContent="space-between" sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: '4px' }}>
                    <Stack>
                      <Typography variant="body2" sx={{ fontWeight: 600 }}>{template.name}</Typography>
                      <Typography variant="caption" color="textSecondary">آخر إرسال: {template.lastSent}</Typography>
                    </Stack>
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Chip label={`${template.recipients} متلقي`} size="small" />
                      <Button size="small">تحرير</Button>
                      <Button size="small" color="success" startIcon={<Send />}>إرسال الآن</Button>
                    </Stack>
                  </Stack>
                ))}
              </Stack>
